...
function Mainbanner() {
  return (
    <div className='relative'>
        ...
        src={assets.main_banner_bg} alt="banner" />
        <img className='w-full md:hidden' 
        src={assets.main_banner_bg_sm} alt="banner" />
        ...
        <div className='flex items-center mt-6 font-medium'>
            ...
            Shop now
            <img className='md:hidden trasition group-focus:translate-x-1' 
            ...
            src={assets.black_arrow_icon} alt="arrow" /></Link>
        </div>
        </div>
    </div>
  )
